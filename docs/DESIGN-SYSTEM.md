...
here before spreading them across pages.

Until the CEO approves a fuller system, use a small coherent token set and
prefer native CSS over new UI dependencies.
